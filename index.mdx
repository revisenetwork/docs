...
<Card title="Why AI Debugging Needs a Hybrid Architecture: Local Context, Cloud Reasoning" icon="star" href="categories/architecture/why-ai-debugging-needs-hybrid-architecture" size="large">
  <img src="/images/hybrid-ai-debugging-architecture.png" alt="Why AI Debugging Needs a Hybrid Architecture: Local Context, Cloud Reasoning" />
