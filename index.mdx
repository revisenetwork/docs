...
<Card title="I Can Write Code Now — So Why Does Debugging Still Eat My Week?" icon="star" href="/categories/debugging-cases/ai-can-write-code-why-debugging-still-hard.mdx" img="/images/blog/ai-debugging-execution-gap.png" cta="Read more">
