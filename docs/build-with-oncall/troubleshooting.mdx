...
description: "Solutions for common errors and configuration issues encountered during setup."
icon: "wrench"
---

# Troubleshooting

This section covers common issues when installing or starting OnCall CLI, based on expected behavior in the codebase.
