...
description: "OnCall CLI lets you control exactly what the AI debugger can see and use for each service. Access is enforced locally in the CLI before any tool call is executed."
icon: "lock"
---
