---
title: "Security"
description: "This section describes the main security properties of OnCall CLI based on how the CLI, the OnCall debugging service, and the cluster server interact."
icon: "shield-check"
---
